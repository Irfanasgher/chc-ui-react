...
function reducer(state = initialState, action) {
    switch (action.type) {
        case actionTypes.GET_PRODUCTS_SUCCESS:
            ...
            case actionTypes.GET_HOBBIYST_PRODUCTS_SUCCESS:
            return {
                ...state,
                ...{ hobbiystProducts: action.data, hobbiystProductsLoading: false },
            };
