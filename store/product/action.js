export const actionTypes = {
    ...
    GET_HOBBIYST_PRODUCTS: 'GET_HOBBIYST_PRODUCTS',
    GET_PRODUCTS_SUCCESS: 'GET_PRODUCTS_SUCCESS',
    GET_HOBBIYST_PRODUCTS_SUCCESS: 'GET_HOBBIYST_PRODUCTS_SUCCESS',
...
export function getHobbiystProducts(payload) {
    return { type: actionTypes.GET_HOBBIYST_PRODUCTS, payload };
}
...
export function getHobbiystProductsSuccess(data) {
    return {
        type: actionTypes.GET_HOBBIYST_PRODUCTS_SUCCESS,
        data,
    };
}
